...
pv.Format.date = function(pattern) {
  return new pv.DateFormat(pattern);
};
 ...
 */
pv.DateFormat.prototype.format = function(d) {
  return this.pattern.replace(/%[a-zA-Z0-9]/g, function(s) {
      switch (s) {
        case '%a': return [
